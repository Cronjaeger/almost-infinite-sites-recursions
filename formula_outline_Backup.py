...
#    p_i5 = prob(deepcopy(phi_i),theta,5,10,P)
    ...
    T = 10
    P = (np.ones((4,4)) - np.eye(4))/3
    p_i6 = prob(deepcopy(phi_i),theta,6,10,P)
    p_i7 = prob(deepcopy(phi_i),theta,7,10,P)
    p_i8 = prob(deepcopy(phi_i),theta,8,10,P)
    p_i9 = prob(deepcopy(phi_i),theta,9,10,P)
    p_i10 = prob(deepcopy(phi_i),theta,10,10,P)
